program codevs_songgeishengdanyedejiduang1293_guanshui_2016_12_11;
const
  dx:array[1..12] of integer=(-2,-1,-1,0,0,1,1,2,1,0,0,-1);
  dy:array[1..12] of integer=(0,0,1,1,2,1,0,0,-1,-1,-2,-1);
var
